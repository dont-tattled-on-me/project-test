        ...
        <div id="form-controller" className="w-[70%]">
          <form onSubmit={(e) => submitHandler(e)}>
            <div className="my-2 flex flex-row justify-start items-center">
              <p className="p-4 text-3xl w-[30%]">วันที่แจ้งซ่อม</p>
              <input
            ...
            <div className="my-2 flex flex-row justify-start items-center">
              <p className="p-4 text-3xl w-[30%]">เวลาแจ้งซ่อม</p>
              <input
                className="p-4 text-jet rounded-xl border-2 border-solid border-[transparent] hover:border-coral focus:border-coral outline-none w-70%"
                type="time"
                placeholder="เวลาแจ้งซ่อม"
              />
            </div>
            ...
            <div className="my-2 flex flex-row justify-start items-center">
              <p className="p-4 text-3xl w-[30%]">สาเหตุการซ่อม</p>
              <input
                className="p-4 text-jet rounded-xl border-2 border-solid border-[transparent] hover:border-coral focus:border-coral outline-none w-70%"
                type="text"
            ...
            <div className="my-2 flex flex-row justify-start items-center">
              <p className="p-4 text-3xl w-[30%]">สถานที่ของอุปกรณ์</p>
              <input
                className="p-4 text-jet rounded-xl border-2 border-solid border-[transparent] hover:border-coral focus:border-coral outline-none w-70%"
                type="text"
